...
with [git](https://git-scm.com/) – that's what [this blog](https://github.com/arangates/aranganathan.vercel.app) uses.
...
```bash
$ curl https://aranganathan.vercel.app/api/page-views?id=databases
