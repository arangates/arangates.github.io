...
It currently has integrations with Firebase, GitHub, and now Spotify!
...
```json
// https://arangates.io/api/top-tracks
...
The source code is available [here](https://github.com/arangates/arangates.io/blob/master/lib/spotify.ts).
